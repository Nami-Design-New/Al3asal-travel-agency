export default function HowWeWorks() {
  return <section className="how_we_work_section">
...
//       },
//     ];
//   return  <section className="benefits py-5 position-relative">
//   <img
...
//     <h2 className="mb-5 text-center">{t("benefits.sectionTitle")}</h2>
